  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "group h-9 w-9 text-center text-sm p-0 relative",
          "[&:has([aria-selected].day-outside)]:bg-accent/50",
          props.mode === "range"
            ? "[&.day-range-end]:rounded-r-md [&.day-range-start]:rounded-l-md [&.day-range-middle]:bg-accent/50"
        ...
        day_button: cn(
          ...
          "group-[.day-range-middle]:aria-selected:bg-transparent group-[.day-range-middle]:aria-selected:text-accent-foreground"
        ),
